...
define("dojo/dom-geometry", ["./sniff", "./_base/window","./dom", "./dom-style"],
	...
	geom.getMarginBox = function getMarginBox(/*DomNode*/ node, /*Object*/ computedStyle){
		...
		}else if(has("opera") || ( undefined  == 8 && ! false )){
	...
	geom.docScroll = function docScroll(/*Document?*/ doc){
		...
		return "pageXOffset" in node ? {x: node.pageXOffset, y: node.pageYOffset } :
			(node =  false  ? win.body(doc) : doc.documentElement) &&
	...
	geom.position = function(/*DomNode*/ node, /*Boolean?*/ includeScroll){
		...
		if( undefined  < 9){
			...
			ret.x -= offset.x + ( false  ? db.clientLeft + db.offsetLeft : 0);
			ret.y -= offset.y + ( false  ? db.clientTop + db.offsetTop : 0);
		}
	...
	geom.normalizeEvent = function(event){
		...
		if(! true ){
			...
			var docBody =  false  ? doc.body : doc.documentElement;
 ...
 *  
 */
define( "walta/SpeedBugTile", [ "dojo/_base/declare", "dojo/_base/lang", "dojo/dom-construct", "dojo/on", "dojo/topic", "dojox/mobile/Pane", "dijit/_Contained" ], 
...
define("dojo/dom-style", ["./sniff", "./dom"], function(has, dom){
	...
	}else if( undefined  && ( undefined  < 9 ||  false )){
	...
	var _getOpacity =
		 undefined  < 9 || ( undefined  < 10 &&  false ) ? function(node){
			try{
	...
	var _setOpacity =
		 undefined  < 9 || ( undefined  < 10 &&  false ) ? function(/*DomNode*/ node, /*Number*/ opacity){
	...
	var _floatStyle =  undefined  ? "styleFloat" : "cssFloat",
...
//		dojo/_base/connect
 ...
 true || has.add("events-keypress-typed", function(){ // keypresses should only occur a printable character is hit
...
if( true ){
	...
	keypress = function(object, listener){
		var keydownSignal = on(object, "keydown", function(evt){
			...
			var unprintable = (k!=13) && k!=32 && (k!=27||! undefined ) && (k<48||k>90) && (k<96||k>111) && (k<186||k>192) && (k<219||k>222) && k!=229;
...
define("dojox/mobile/sniff", [
	...
	if( true ){
		 true || has.add('touch', (typeof win.doc.documentElement.ontouchstart != "undefined" &&
...
define("dojo/_base/event", ["./kernel", "../on", "../has", "../dom-geometry"], function(dojo, on, has, dom){
	...
	var ret = {
		...
		stop: function(/*Event*/ evt){
			...
			if( true  || (evt && evt.preventDefault)){
				evt.preventDefault();
				evt.stopPropagation();
			}else{
...
define("dojo/dom-prop", ["exports", "./_base/kernel", "./sniff", "./_base/lang", "./dom", "./dom-style", "./dom-construct", "./_base/connect"],
	...
	exports.set = function setProp(/*DOMNode|String*/ node, /*String|Object*/ name, /*String?*/ value){
		...
		if(propName == "innerHTML"){
			...
			if( undefined  && node.tagName.toLowerCase() in {col: 1, colgroup: 1,
...
define("dojo/keys", ["./_base/kernel", "./sniff"], function(dojo, has){
	...
	return dojo.keys = {
		...
		RIGHT_DPAD: 178,
		// virtual key mapping
		copyKey: has("mac") && ! false  ? (has("safari") ? 91 : 224 ) : 17
	};
});
 ...
 *  
 */
define( "walta/PhotoView", [ "dojo/_base/declare", "dojo/_base/array", "dojo/on", "dojo/aspect", "dojo/dom-construct", "dojo/_base/lang", "dojox/mobile/ContentPane", "dojox/mobile/SwapView", "dojox/mobile/Carousel" ], 
...
define("dojo/mouse", ["./_base/kernel", "./on", "./has", "./dom", "./_base/window"], function(dojo, on, has, dom, win){
	...
	//		dojo/mouse
     ...
     false && has.add("dom-quirks", win.doc && win.doc.compatMode == "BackCompat");
	 false && has.add("events-mouseenter", win.doc && "onmouseenter" in win.doc.createElement("div"));
	...
	dijit._getTabNavigable = function(/*DOMNode*/ root){
		...
		var walkTree = function(/*DOMNode*/ parent){
			for(var child = parent.firstChild; child; child = child.nextSibling){
				...
				if(child.nodeType != 1 || ( undefined  <= 9 && child.scopeName !== "HTML") || !shown(child)){
					continue;
				}
 ...
 */
define( "walta/Key", [ "dojo/_base/declare", "dojo/request/xhr", "dojo/_base/lang", "dojo/_base/array", "walta/XmlDocument", "walta/KeyNode", "walta/Taxon", "walta/Question"  ], 
 ...
 *  
 */
define( "walta/VideoView", [ "dojo/_base/declare", "dojo/_base/array", "dojo/on", "dojo/aspect", "dojo/dom-construct", "dojo/dom-class", "dojo/dom-style", "dojo/_base/lang", "dojox/mobile/ContentPane", "dojox/mobile/SwapView", "dojox/mobile/Carousel" ], 
...
var unionSplit = /([^\s,](?:"(?:\\.|[^"])+"|'(?:\\.|[^'])+'|[^,])*)/g;
 true || has.add("dom-matches-selector", !!matchesSelector);
 true || has.add("dom-qsa", !!querySelectorAll); 
...
'walta/Question':function(){
define( "walta/Question", [ "dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "walta/Taxon" ], function( declare, array, lang, Taxon ) {
	return declare( null, {
...
define("dojo/ready", ["./_base/kernel", "./has", "require", "./domReady", "./_base/lang"], function(dojo, has, require, domReady, lang){
	...
	if( true  && dojo.config.parseOnLoad && !dojo.isAsync){
		ready(99, function(){
			if(!dojo.parser){
...
define("dojo/window", ["./_base/lang", "./sniff", "./_base/window", "./dom", "./dom-geometry", "./dom-style"],
	...
	var window = {
		...
		getBox: function(/*Document?*/ doc){
			...
			if( true ){ // if(scrollbars not supported)
		...
		get: function(/*Document*/ doc){
			...
			if( undefined  && window !== document.parentWindow){
				/*
		...
		scrollIntoView: function(/*DomNode*/ node, /*Object?*/ pos){
			...
			try{ // catch unexpected/unrecreatable errors (#7808) since we can recover using a semi-acceptable native method
				...
				var doc = node.ownerDocument || baseWindow.doc,	// TODO: why baseWindow.doc?  Isn't node.ownerDocument always defined?
					...
					isIE =  undefined , isWK =  true ;
				// if an untested browser, then use the native method
				if((!( undefined  || isIE || isWK || has("opera")) || node == body || node == html) && (typeof node.scrollIntoView != "undefined")){
...
// Flag to make dijit load modules the app didn't explicitly request, for backwards compatibility
 false && has.add("dijit-legacy-requires", !kernel.isAsync);
