define("dojo/_firebug/firebug", [
	...
	if(
		...
		dojo.config.useCustomLogger ||				// Allow custom loggers
		 false 									// isDebug triggers AIRInsector, not Firebug
	){
		return;
	}
	...
	function createFrame(){
		...
		addEvent(_firebugDoc,  undefined  || has("safari") ? "keydown" : "keypress", onKeyDown);
	...
	addEvent(document,  undefined  || has("safari") ? "keydown" : "keypress", onKeyDown);
	...
	dojo.addOnWindowUnload(function(){
		...
		removeEvent(document,  undefined  || has("safari") ? "keydown" : "keypress", onKeyDown);
