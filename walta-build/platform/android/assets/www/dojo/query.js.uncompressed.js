define("dojo/query", ["./_base/kernel", "./has", "./dom", "./on", "./_base/array", "./_base/lang", "./selector/_loader", "./selector/_loader!default"],
	...
	"use strict";
	 ...
	 true || has.add("array-extensible", function(){
		// test to see if we can extend an array (not supported in old IE)
		return lang.delegate([], {length: 1}).length == 1 && ! 0 ;
	});
	...
	var NodeList = function(array){
		...
		//		|			.style("padding", "5px")
		//		|			.forEach(console.log);
		var isNew = this instanceof nl &&  true ;
	...
	var nl = NodeList, nlp = nl.prototype = 
		 true  ? [] : {};// extend an array if it is extensible
