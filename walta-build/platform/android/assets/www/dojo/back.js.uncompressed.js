define("dojo/back", ["./_base/config", "./_base/lang", "./sniff", "./dom", "./dom-construct", "./_base/window", "require"],
	...
	var back = {
	 ...
	 true  && lang.setObject("dojo.back", back);
	...
	var getHash = back.getHash = function(){
		...
		return  undefined  ? h : decodeURIComponent(h);
	},
	...
	function loadIframeHistory(){
		...
		moveForward = true;
		if(historyIframe){
			 true  ? historyIframe.location = url : window.frames[historyIframe.name].location = url;
		}else{
