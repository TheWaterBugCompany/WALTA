define("dijit/_editor/RichText", [
	...
	"dojo/query", // query
	"dojo/ready", // ready
	"dojo/sniff", //  undefined   undefined  has("opera") has("safari")  true 
...
var RichText = declare("dijit._editor.RichText", [_Widget, _CssStateMixin], {
	...
	open: function(/*DomNode?*/ element){
		...
		if(lang.isString(this.value)){
			...
			var tmpFunc = lang.hitch(this, function(){
				...
				if( undefined ){ //nasty IE bug: abnormal formatting if overflow is not hidden
					var s = ta.style;
	...
	_getIframeDocTxt: function(){
		...
		var html = "";
		var setBodyId = true;
		if( undefined  ||  true  || (!this.height && ! undefined )){
		...
		return [
			...
			( undefined  && label.length ? "<title>" + label[0].innerHTML + "</title>\n" : ""),
...
//			console.debug("dijit/_editor/RichText.removeStyleSheet(): Style sheet "+url+" has not been applied");
	...
	_setDisabledAttr: function(/*Boolean*/ value){
		...
		if( undefined  ||  true  || has("opera")){
			var preventIEfocus =  undefined  && (this.isLoaded || !this.focusOnLoad);
 ...
 *****************/
	...
	onLoad: function(/*String*/ html){
		...
		if(! undefined  && ! true  && (this.height ||  undefined )){
			...
			var _this = this;
			if( undefined ){ // #4996 IE wants to focus the BODY tag
		...
		if( undefined ){ // IE contentEditable
	...
	blur: function(){
		...
		// tags:
		//		deprecated
		if(! undefined  && this.window.document.documentElement && this.window.document.documentElement.focus){
	...
	_normalizeCommand: function(/*String*/ cmd, /*Anything?*/argument){
		...
		}else if(command === "hilitecolor" && ! undefined ){
			command = "backcolor";
		}
	...
	_queryCommandAvailable: function(/*String*/ command){
		...
		return ( undefined  && supportedBy.ie) ||
			( undefined  && supportedBy.mozilla) ||
			( true  && supportedBy.webkit) ||
	...
	execCommand: function(/*String*/ command, argument){
		...
		if(argument !== undefined){
			...
			}else if((command === "formatblock") &&  undefined ){
				argument = '<'+argument+'>';
			}
		}
	...
	queryCommandValue: function(command){
		...
		var r;
		command = this._normalizeCommand(command);
		if( undefined  && command === "formatblock"){
			r = this._native2LocalFormatNames[this.document.queryCommandValue(command)];
		}else if( undefined  && command === "hilitecolor"){
			var oldValue;
			try{
	...
	setValue: function(/*String*/ html){
		...
		if(this.textarea && (this.isClosed || !this.isLoaded)){
			...
			if(html &&  undefined  && html.toLowerCase() === "<p></p>"){
				html = "<p>&#160;</p>";	// &nbsp;
			}
	...
	replaceValue: function(/*String*/ html){
		...
		if(this.isClosed){
			this.setValue(html);
		}else if(this.window && this.window.getSelection && ! undefined ){ // Safari
	...
	******************************************************************************/
	...
	_browserQueryCommandEnabled: function(command){
		...
		var elem =  undefined  ? this.document.selection.createRange() : this.document;
		try{
	...
	_unlinkImpl: function(argument){
		...
		// tags:
		//		protected
		if((this.queryCommandEnabled("unlink")) && ( undefined  ||  true )){
	...
	_inserthtmlImpl: function(argument){
		...
		}else if( undefined  && !argument.length){
