define("dijit/Editor", [
	...
	"dojo/sniff", //  undefined  has("mac")  true 
	...
	var Editor = declare("dijit.Editor", RichText, {
		...
		_clipboardCommand: function(cmd){
			...
			try{
				...
				if( true  && !r){ //see #4598: webkit does not guarantee clipboard support from js
		...
		onKeyDown: function(e){
			...
			if(! undefined  && !this.iframe && e.keyCode == keys.TAB && !this.tabIndent){
				this._saveSelection();
			}
			if(!this.customUndo){
				this.inherited(arguments);
