		...
		if(coords){
			if(iframe){
				...
				var cs = domStyle.getComputedStyle(iframe),
					...
					left = ( undefined  &&  false  ? 0 : tp(iframe, cs.paddingLeft)) + ( undefined  &&  false  ? tp(iframe, cs.borderLeftWidth) : 0),
					top = ( undefined  &&  false  ? 0 : tp(iframe, cs.paddingTop)) + ( undefined  &&  false  ? tp(iframe, cs.borderTopWidth) : 0);
