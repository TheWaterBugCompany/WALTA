...
define("dijit/layout/ScrollingTabController", [
	...
	"dojo/on",
	"dojo/query", // query
	"dojo/sniff", //  undefined ,  true ,  false 
...
var ScrollingTabController = declare("dijit.layout.ScrollingTabController", [TabController, _WidgetsInTemplateMixin], {
	...
	_getScroll: function(){
		...
		return (this.isLeftToRight() ||  undefined  < 8 || ( undefined  &&  false ) ||  true ) ? this.scrollNode.scrollLeft :
				domStyle.get(this.containerNode, "width") - domStyle.get(this.scrollNode, "width")
					 + ( undefined  >= 8 ? -1 : 1) * this.scrollNode.scrollLeft;
	},
	...
	_convertToScrollLeft: function(val){
		...
		if(this.isLeftToRight() ||  undefined  < 8 || ( undefined  &&  false ) ||  true ){
			return val;
		}else{
			var maxScroll = domStyle.get(this.containerNode, "width") - domStyle.get(this.scrollNode, "width");
			return ( undefined  >= 8 ? -1 : 1) * (val - maxScroll);
		}
	},
