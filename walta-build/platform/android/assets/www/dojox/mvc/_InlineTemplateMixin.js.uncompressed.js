define("dojox/mvc/_InlineTemplateMixin", [
	...
	return declare("dojox.mvc._InlineTemplateMixin", null, {
		...
		buildRendering: function(){
			...
			if(root){
				var nodes =  true  ? root.querySelectorAll("script[type='dojox/mvc/InlineTemplate']") : root.getElementsByTagName("script"),
				 templates = [];
				for(var i = 0, l = nodes.length; i < l; ++i){
					if(! true  && nodes[i].getAttribute("type") != "dojox/mvc/InlineTemplate"){ continue; }
