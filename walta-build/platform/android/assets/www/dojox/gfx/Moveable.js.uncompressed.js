  ...
  function(lang,declare,arr,event,topic,has,domClass,win,Mover){
	...
	return declare("dojox.gfx.Moveable", null, {
		constructor: function(shape, params){
			...
			this.events = [
				this.shape.connect( true  ? "touchstart" : "mousedown", this, "onMouseDown")
		...
		onMouseDown: function(e){
			...
			if(this.delay){
				this.events.push(
					this.shape.connect( true  ? "touchmove" : "mousemove", this, "onMouseMove"),
					this.shape.connect( true  ? "touchend" : "mouseup", this, "onMouseUp"));
				this._lastX =  true  ? (e.changedTouches ? e.changedTouches[0] : e).clientX : e.clientX;
				this._lastY =  true  ? (e.changedTouches ? e.changedTouches[0] : e).clientY : e.clientY;
			}else{
		...
		onMouseMove: function(e){
			...
			// e: Event
			//		mouse event
			var clientX =  true  ? (e.changedTouches ? e.changedTouches[0] : e).clientX : e.clientX,
				clientY =  true  ? (e.changedTouches ? e.changedTouches[0] : e).clientY : e.clientY;
