...
var speedBugResource = "/spec/resources/simpleKey1/media/speedbug/";
...
var taxons = [
    ...
    Taxon.createTaxon({ taxonId: 2, name: "Amphipoda",  commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
    ...
    Taxon.createTaxon({ taxonId: 7, name: "Amphipoda",  commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
    ...
    Taxon.createTaxon({ taxonId: 12, name: "Amphipoda",  commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
    ...
    Taxon.createTaxon({ taxonId: 17, name: "Amphipoda", commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
    ...
    Taxon.createTaxon({ taxonId: 22, name: "Amphipoda", commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
    ...
    Taxon.createTaxon({ taxonId: 27, name: "Amphipoda", commonName: "Amphipoda", bluebug: [ speedBugResource + "amphipoda_b.png" ] }),
   ];
