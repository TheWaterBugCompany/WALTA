...
describe("EditTaxon controller", function() {
    ...
    it('should trigger close event when save button clicked', async () => {
        makeEditTaxon( { taxonId:"1", abundance:"3-5", taxonPhotoPath: "/spec/resources/simpleKey1/media/amphipoda_01.jpg" } );
        await windowOpenTest( win ); 
    ...
    it('save should be enabled if a photo is selected', function(done) {
        ...
        windowOpenTest( win, () => {
            ctl.photoSelect.on("loaded", function handler() {
                ...
                ctl.setImage("/spec/resources/simpleKey1/media/amphipoda_01.jpg")
            }) ;
        }); 
    });
    ...
    it('should call the save event when save is selected', function(done) {  
        ...
        windowOpenTest( win, () => {
            ...
            ctl.setImage("/spec/resources/simpleKey1/media/speedbug/amphipoda_b.png")
        } );
    });
    ...
    it("should display an unknown bug", function(done) {
        makeEditTaxon( { taxonId:null, abundance:"1-2", taxonPhotoPath: "/spec/resources/simpleKey1/media/amphipoda_01.jpg"} );
        windowOpenTest( win, function() {
            checkTestResult( done, 
                function() {
    ...
    it("should allow multiple unknown bugs", async function() {
        let taxons = [ 
            createMockTaxon( {taxonId:null, abundance:"1-2", taxonPhotoPath: "/spec/resources/simpleKey1/media/amphipoda_01.jpg"} ),
            createMockTaxon( {taxonId:null, abundance:"6-10", taxonPhotoPath: "/spec/resources/simpleKey1/media/parastacide_01.jpg"} ),
        ]
    ...
    it.skip('should mark taxon for deletion when delete pressed', async function() {
        let taxon1 = makeEditTaxon( { taxonId:null, abundance:"1-2", taxonPhotoPath: "/spec/resources/simpleKey1/media/amphipoda_01.jpg"} );
        await windowOpenTest( win );
    ...
    it("should set the serverCreaturePhotoId to null if the photo is updated", async () => {
        let taxon1 = makeEditTaxon( { sampleId: 666, serverCreaturePhotoId: 616, taxonId:1, abundance:"1-2", taxonPhotoPath: "/spec/resources/simpleKey1/media/amphipoda_01.jpg", } );
        await windowOpenTest( win );
