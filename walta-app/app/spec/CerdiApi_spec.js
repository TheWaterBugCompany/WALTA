...
var { makeTestPhoto, removeDatabase, resetSample, clearDatabase } = require("spec/util/TestUtils");
...
describe('#retrieveSamples', function () {
    ...
    const sitePhotoPath = "/spec/resources/site-mock.jpg";
    const creaturePhotoPath = "/spec/resources/simpleKey1/media/amphipoda_01.jpg";
