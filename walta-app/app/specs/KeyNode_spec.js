	...
	var kn = KeyNode.createKeyNode( {
		questions: [
			Question.createQuestion({
				text: "Question 1",
				outcome: null,
				mediaUrls: [ "specs/resources/simpleKey1/media/amphipoda_01.jpg" ]
			}),
			Question.createQuestion({
				text: "Question 2",
				outcome: null,
				mediaUrls: [ "specs/resources/simpleKey1/media/amphipoda_02.jpg", "specs/resources/simpleKey1/media/attack_caddis_01_x264.mp4" ]
			})
		],
		parentLink: null
	});
