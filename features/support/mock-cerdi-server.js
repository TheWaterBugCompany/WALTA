...
const { makeCerdiSampleData } = require('../../walta-app/app/lib/spec/fixtures/SampleData_fixture.js');
...
function createMockCerdiServer(callback) {
    ...
    return { 
        ...
        makeMockSample() {
            ...
            this.hockServer
                .get('/photos/1/view')
                .replyWithFile(200, path.join(__dirname,'../../walta-app/app/lib/spec/resources/site-mock.jpg'));
            this.hockServer
            ...
            this.hockServer
                .get('/photos/2/view')
                .replyWithFile(200, path.join(__dirname,'../../walta-app/app/lib/spec/resources/simpleKey1/media/amphipoda_01.jpg'));
            this.hockServer
                .get('/photos/3/view')
                .replyWithFile(200, path.join(__dirname,'../../walta-app/app/lib/spec/resources/simpleKey1/media/phreatoicidae.jpg'));
        }
    };
}
