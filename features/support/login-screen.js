...
class LoginScreen extends BaseScreen {
    ...
    async login( email, password ) {
        ...
        // The iOS Save Password sheet can appear unpredictably after submit
        // (sometimes immediately, sometimes 20+ seconds later on contended
        // runners, sometimes not at all if iOS has remembered "Not Now"
        // for this credential). Don't try to dismiss it inline — the next
        // screen-wait via BaseScreen.waitForRaw probes for it and retries.
    }
} 
